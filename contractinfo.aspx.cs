...
namespace WebApplication1
{
    public partial class contractinfo : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataTable dataTable = new DataTable("Contracts");
            dataTable.Columns.Add("Contracts");
            dirs = Directory.GetFiles(Server.MapPath("Contracts") + "\\");

            foreach (string dir in dirs)
            {
                string fn = Path.GetFileName(dir);
                dataTable.Rows.Add(fn);
            }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            foreach (string dir in dirs)
            {
                if (dir.Contains(staff_grid.Rows[staff_grid.SelectedIndex].Cells[0].Text))
                {
                    ...
                    Session["Message"] = "The specified contract file has been deleted from the system. You will be redirected to the portal in 20 seconds.";
        ...
        protected void btnUpload_Click(object sender, EventArgs e)
        {
            ...
            if (file != null && file.ContentLength > 0)
            {
                try
                {
                    ...
                    Session["Message"] = "The contract file has been uploaded to the system. You may now reference it from the contract-info page at any time. This page will redirect within 20 seconds.";
                    Response.AddHeader("REFRESH", "20;URL=portal.html");
                    return;
                }
                catch (Exception ex)
