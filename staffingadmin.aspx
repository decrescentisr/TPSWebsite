<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="staffingadmin.aspx.cs" Inherits="WebApplication1.staffingadmin" %>
...
<body>
    ...
    <div class="hero-image">
        <img src="images/staffingadmin.jpeg" class="responsive" />
        <div class="hero-text">
            <h1 style="color: white; font-size: 35px;">Staffing Admin</h1>
        </div>
    </div>
