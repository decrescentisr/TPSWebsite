...
{
    public partial class staffingrequestinfo : System.Web.UI.Page
    {
        DataLayer dataLayer;
        DataSet ds;
        ...
        {
            // Security Check
            if (Session["Security"].ToString() == "Staff")
            {
                Server.Transfer("index.aspx", true);
            }
            else if (Session["Security"].ToString() == "Manager" || Session["Security"].ToString() == "Client")
            {
                // Do nothing
            }
            else
        ...
        protected void btnUpdateRequest_Click(object sender, EventArgs e)
        {
            ...
            if (tbLocation.Text != "" && tbSalary.Text != "" && selectedStaff[0] != "")
            {
                ...
                dataLayer.updateRequest(tbSearch.Text, stafflist, tbLocation.Text, ddlWork.SelectedValue, tbSalary.Text, myDict["status"]);
        ...
        {
            dataLayer.deleteRequest(tbSearch.Text);
            Session["Title"] = "<h1>Request Deleted</h1>";
            Session["Message"] = "Your request has been deleted. Please contact TPS for any and all questions. Thank you and have a great day! This page will redirect within 20 seconds.";
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            if (tbSearch.Text != "")
            {
                ...
                myDict = dataLayer.getRequest(tbSearch.Text, Session["UserID"].ToString());
